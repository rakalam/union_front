  ...
  return (
    <div className=''>
      <div
        ...
        <div className='w-[28rem] sm:w-[30rem] z-30 rounded mx-[6vw] text-center sm:text-start text-gray-900'>
          <h6 className="text-[3em] font-extrabold">Gestion des personnels</h6>
          <h6 className="text-[3em] font-extrabold">Suivi des pointages</h6>
          ...
          <div className='grid grid-cols-2 gap-4 mt-5 w-full sm:w-[70%]'>
            <button
              onClick={commencer}
              className='flex items-center justify-center px-3 py-2 space-x-3 shadow-xl shadow-gray-300 bg-gray-900 text-gray-200 rounded-lg border border-[transparent] font-[500] hover:bg-gray-950 duration-100 hover:border-gray-200'>
              <FaChartLine />
              <p>Graphisme</p>
            </button>
            ...
            <button
              onClick={commencer}
              className='flex items-center justify-center px-3 py-2 space-x-3 text-gray-200 rounded-lg shadow-2xl shadow-gray-300 bg-orange_union border border-[transparent] hover:bg-orange_union_100 hover:border-gray-200'>
              <TbActivity />
              <p>Activité</p>
            </button>
            ...
            <button
              onClick={commencer}
              className='flex items-center justify-center px-3 py-2 shadow-xl shadow-gray-300 space-x-3 text-gray-500 rounded-lg border-[3px] border-gray-500 hover:border-gray-900 hover:text-gray-950'>
              <FaSearch />
              <p>Analyse</p>
            </button>
