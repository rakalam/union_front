...
const ListePlanning = ({listePlanning, planningPerPage, totalPlanning, paginate, pageCourrant}) => {
    ...
    <>
        <table className='min-w-full'>
          <thead className='border-b-2 border-gray-300'>
            ...
            <th className='w-[7em]'>
            <div className='flex items-center justify-center py-[20px] space-y-2 font-bold rounded text-gray-900 text-[12px]'>
                Action
              </div>
            </th>
                    ...
                    <td>
                      <div className='flex items-center justify-between px-3 py-2 rounded'>
                        <div className={`flex items-center justify-center w-8 h-8 px-2 font-bold  border-[2px]  rounded-full 
                           ${l.sexe === "masculin" ? "text-white bg-blue-300 border-blue-500"
                            : "border-orange-500 text-white bg-orange-300"}`}>
                           {l.photos}
                        </div>
                        <div className='flex flex-col items-end justify-center -space-y-1'>
                          <font>{l.id}</font>
                          <p className='text-[11px]'>{l.nom}</p>
                        </div>
                      </div>
                    </td>
                    <td>
