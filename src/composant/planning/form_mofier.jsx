...
const Form_mofier = ({ var_id_planning, var_id_personnel,var_identifiant, var_prenom, select_personnel, select_planning, hide_blur }) => {
    ...
    const soumettre_modifeir_planning = (e) => {
        e.preventDefault()
        if (validation()) {
            const formData = new FormData();
            formData.append("id_planning", var_id_planning);
            formData.append("id_personnel", var_id_personnel);
            ...
            axios
                .post("http://localhost:8000/api/modifie_planning", formData)
                .then(response => {
                    document.getElementById("type_lundi_m").value = ""
                    document.getElementById("type_mardi_m").value = ""
                    document.getElementById("type_mercredi_m").value = ""
                    document.getElementById("type_jeudi_m").value = ""
                    document.getElementById("type_vendredi_m").value = ""
                    document.getElementById("type_samedi_m").value = ""
                    document.getElementById("type_dimanche_m").value = ""
                    setType_lundi('off')
                    setType_mardi('off')
    ...
    return (
        <>
            {/* formulaire odifer planning  */}
            <div className=" w-[90vw] md:w-[70vw] lg:w-[50vw] h-auto bg-white rounded-[1em] fixed z-50 px-4 py-4 dark:bg-[#121212] dark:text-gray-100 form_modifier_planning" style={{
                top: '-50%', left: '50%', transform: 'translate(-50%, -50%)'
            }}>

                <div className="flex items-center justify-between mt-1 mb-4">
                    <font> Modification Planning</font>
                ...
                <div className='flex items-center justify-between'>
                    <div>
                        <font>Personnel : </font> <font className="text-orange_union">{" "} {var_prenom}</font>
                    </div>

                </div>
                <form onSubmit={soumettre_modifeir_planning} name='F'>
                    <table className="w-full text-center">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select name="" id='type_lundi_m' className='tailwind-form' onChange={typeLundi}>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select name="" id='type_mardi_m' className='tailwind-form' onChange={typeMardi}>
                                        <option value="" selected disabled  >Type de Shift</option>
                                        <option value="shift">Shift</option>
                                        <option value="off">OFF</option>
                                    </select>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select name="" id='type_mercredi_m' className='tailwind-form' onChange={typeMercredi}>
                                        <option value="" selected disabled  >Type de Shift</option>
                                        <option value="shift">Shift</option>
                                        <option value="off">OFF</option>
                                    </select>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select name="" className='tailwind-form' id='type_jeudi_m' onChange={typeJeudi}>
                                        <option value="" selected disabled  >Type de Shift</option>
                                        <option value="shift">Shift</option>
                                        <option value="off">OFF</option>
                                    </select>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select name="" className='tailwind-form' id='type_vendredi_m' onChange={typeVendredi}>
                                        <option value="" selected disabled  >Type de Shift</option>
                                        <option value="shift">Shift</option>
                                        <option value="off">OFF</option>
                                    </select>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select name="" className='tailwind-form' id='type_samedi_m' onChange={typeSamedi}>
                                        <option value="" selected disabled  >Type de Shift</option>
                                        <option value="shift">Shift</option>
                                        <option value="off">OFF</option>
                                    </select>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select name="" className='tailwind-form' id='type_dimanche_m' onChange={typeDimanche}>
                                        <option value="" selected disabled  >Type de Shift</option>
                                        <option value="shift">Shift</option>
                                        <option value="off">OFF</option>
                                    </select>
                    ...
                    <div>
                        <div className='flex items-center justify-start space-x-4'>
                            ...
                            <span 
                            onClick={hide_blur}
                            className="cursor-pointer flex items-center justify-center space-x-3 my-4 sm:text-[12px] text-[1em] px-2 py-1 bg-[red] text-white rounded">
                                <IoMdClose />
